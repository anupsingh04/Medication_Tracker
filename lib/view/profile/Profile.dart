    ...
    return Scaffold(
      ...
      body: NestedScrollView(
        headerSliverBuilder: (BuildContext context, bool innerBoxIsScrolled) {
          return [
            SliverAppBar(
              title: Text(_tab[_tabController.index].item1,
              ...
              actions: [
                ValueListenableBuilder(
                    ...
                    builder: (context, value, widget) {
                      return IconButton(
                          icon:
                              Icon(isEditable.value ? Icons.close : Icons.edit),
                          tooltip: isEditable.value
                              ? 'Leave'
                              : 'Make Changes (Edit)',
                          color: Colors.black,
                          onPressed: () {
        ...
        body: TabBarView(
          controller: _tabController,
          children: _tab.map<Widget>((Tuple3 page) => page.item2).toList(),
        ),
      ),
    );
  }
